...
Source Section  : Example: Use Junos PyEZ to Load Configuration Data from a File
Source URL      : https://www.juniper.net/documentation/us/en/software/junos-pyez/junos-pyez-developer/topics/example/junos-pyez-program-configuration-data-loading-from-file.html
"""
